    ...
    return(
        <div className='categorias'>
            <form onSubmit={createCategoria}>
                ...
                <button id='btn_salvar' type='submit'>{onEdit? 'Alterar' : 'Salvar'}</button>
            </form>
            <div className='col'>
                {
                    categorias.map(categoria => (
                        <div className='row' key={categoria._id}>
                            <p>{categoria.nome}</p>
                            <div>
                                <button onClick={() => editCategoria(categoria._id, categoria.nome)}><EditIcon />Editar</button>
                                <button onClick={() => deleteCategoria(categoria._id)}>< DeleteOutlineIcon/>Excluir</button>
                            </div>
                        </div>
                    ))
                }
